                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr v-for="log in logs.data" :key="log.id" class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-4 py-3 text-gray-500 text-xs">{{ log.dispensed_at }}</td>
                        ...
                        <tr v-if="!logs.data?.length"><td colspan="7" class="px-4 py-12 text-center text-gray-400">No dispensing records</td></tr>
                    </tbody>
                </table>
            </div>
