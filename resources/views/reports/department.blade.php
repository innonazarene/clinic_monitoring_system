...
<head>
    ...
    <style>
        ...
        .stat-grid { display: flex; gap: 20px; margin: 10px 0; }
        .stat-box { background: #f0f4f8; padding: 10px; border-radius: 5px; flex: 1; text-align: center; }
        .stat-number { font-size: 20px; font-weight: bold; color: #1b2a4a; }
...
<body>
        ...
        <table style="border: none; margin-bottom: 0;">
            <tr>
                ...
                <td style="border: none; text-align: center; padding: 0;">
                    ...
                    <h2 style="margin-left: -70px;">Department Report - {{ $department->full_name }} ({{ $department->code }})</h2>
                </td>
            </tr>
        </table>
    </div>
    ...
    <table>
        <thead>
            <tr><th>#</th><th>ID</th><th>Name</th><th>Sex</th><th>BMI</th><th>Category</th><th>Allergies</th></tr>
        </thead>
        <tbody>
    ...
    <table>
        <thead>
            <tr><th>#</th><th>ID</th><th>Name</th><th>Position</th><th>BMI</th><th>Category</th></tr>
        </thead>
        <tbody>
